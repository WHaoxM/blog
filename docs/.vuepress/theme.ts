...
export default hopeTheme(
  {
    ...
    hostname: "https://neutronm.store",
    author: {
      name: "LearnCoding",
      url: "https://neutronm.store",
    },
    ...
    copyright: `
  版权声明：Copyright © 2024-present LearnCoding | <a href="https://github.com/whaoxm" target="_blank" rel="noopener noreferrer">NeuTronM</a> <a href="https://creativecommons.org/licenses/by-nc-nd/4.0/deed.zh-hans" target="_blank" rel="noopener noreferrer">（创意共享 4.0 许可证）</a>
  `,
    displayFooter: true,
    ...
    blog: {
      ...
      description: "一名minecraft 12年牢玩家，继续提升自己，输出我的价值",
      intro: "/intro.html",
      medias: {
        GitHub: "https://github.com/WHaoxM",
        Twitter: "https://x.com/EmonaKhatun",
        Zhihu: "https://www.zhihu.com/people/hosheil",
        Email: "mailto:neutronm2024@outlook.com",
        Discord: "https://discord.gg/whaoxm",
        RSS: "/rss.xml",
      },
    },
